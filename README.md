commit: [772d10872992e34e6576027c697c11646a8e4647](https://github.com/rcmdnk/python-action-test/tree/772d10872992e34e6576027c697c11646a8e4647)

condition: branch=main, os=ubuntu-latest, python_version=3.10

[![test](https://github.com/rcmdnk/python-action-test/actions/workflows/dispatch.yml/badge.svg)](https://github.com/rcmdnk/python-action-test/actions/runs/4097379277)
...
| ----- | ------- | -------- | -------- | ------------------ |
| 4 | 0 :zzz: | 0 :x: | 0 :fire: | 0.145s :stopwatch: |
